...
public class GenericFunctionalInterfaeDemo {
	public static void main(String[] args) {

		/*
		 * Esta expressão lambda determina se um inteiro é fator de outro.
		 */
		...
		/*
		 * A próxima expressão lambda determina se um Double é fator de outro.
		 */
